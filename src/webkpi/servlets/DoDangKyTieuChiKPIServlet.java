...
/**
 * Servlet implementation class DoDangKyTieuChiKPIServlet
 */
@WebServlet("/doDangKyTieuChiKPI")
public class DoDangKyTieuChiKPIServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DoDangKyTieuChiKPIServlet() {
        super();
		...
		Connection conn = MyUtils.getStoredConnection(request);
	     ...
	     // TieuChi tieuchi = null;
	      ...
	      // Redirect sang trang danh sách sản phẩm.
	          ...
	          response.sendRedirect(request.getContextPath() + "/doDangKyKPI");
	      }
	}

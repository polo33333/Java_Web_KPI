...
/**
 * Servlet implementation class CreateTieuChiServlet
 */
@WebServlet("/createTieuChi")
public class CreateTieuChiServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CreateTieuChiServlet() {
        super();

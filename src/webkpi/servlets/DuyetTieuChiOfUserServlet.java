...
/**
 * Servlet implementation class DuyetTieuChiOfUserServlet
 */
@WebServlet("/DuyetTieuChiOfUser")
public class DuyetTieuChiOfUserServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DuyetTieuChiOfUserServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			list = DBUtils.queryListTieuChiOfUser(conn,mabieumau);
		...
		RequestDispatcher dispatcher = request.getServletContext()
				.getRequestDispatcher("/views/chamdiemkpi.jsp");

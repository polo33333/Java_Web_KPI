            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="thongkekpi.jsp"><span class="glyphicon glyphicon-signal"></span> Thống kê KPI</a></li>
                    </ul>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="row">
                    <h2>Biểu đồ</h2>
                    <p>Biểu diễn KPI!</p>
                 <div id="chartContainer" style="height: 250px; width: 1100px;"></div>   
                </div>
                </div>
            </div>
                <!-- end colum 1 row 1 -->
                      ...
                      <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    <td>Biểu mẫu 1</td>
                                    <td>11-10-16</td>
                                    <td><button type="button" class="btn btn-primary"><a href="#"></a>Xem</button></td>
                                </tr>
                                <tr>
                                    <td>Biểu mẫu 2</td>
                                    <td>12-10-16</td>

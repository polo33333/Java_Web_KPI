                ...
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            <th>STT</th>
                            <th>Tên Tiêu Chí</th>
                            <th>Điểm Đánh Giá 1</th>
                            <th>Điểm Đánh Giá 2</th>
                            <th>Điểm Đánh Giá 3</th>
                            <th>Điểm Đánh Giá 4</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr class="active">
                            <td>1</td>
                            <td>Tiêu chí 1</td>
                           <td><div class="col-md-4"><input class=" col-md-8 form-control" id="disabledInput" type="text" value="0"></div></td>
                            <td><div class="col-md-4"><input class=" col-md-8 form-control" id="disabledInput" type="text" value="0"></div></td>
                            <td><div class="col-md-4"><input class=" col-md-8 form-control" id="disabledInput" type="text" value="0"></div></td>
                            <td><div class="col-md-4"><input class=" col-md-8 form-control" id="disabledInput" type="text" value="0"></div></td>
                        </tr>

        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbar-collapse">
                <ul class="nav navbar-nav links">
                    ...
                    <li class="active" role="presentation"><a href="quanlykpi.jsp"><span class="fa fa-table"></span> Quản Lý KPI</a></li>
                    <li role="presentation">
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr class="active">
                            ...
                            <td>12-9-2016</td>
                            <td>Đã hoàn thành</td>
                            <td><button type="button" class="btn btn-primary"><a href="#"></a>Xem, Sửa</button></td>
                        </tr>
                        <tr class="success">
                            <td>2</td>
                            <td>Biểu Mẫu 2</td>

...
<head>
    ...
    <title>KPI Web | Đăng Kí KPI</title>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbar-collapse">
                <ul class="nav navbar-nav links">
                    ...
                    <li class="active"  role="presentation"><a href="dangkikpi.jsp"><span class="glyphicon glyphicon-signal"></span> Đăng Kí KPI</a></li>
                </ul>
        ...
        <div class="container">
            <div class="row layout">
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-12">
                            <h2 class="text-center">Đăng Kí KPI</h2>
                        </div>
                        <!-- end h2 tiêu đề -->
                        <div class="col-md-12">
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr class="active">
                            ...
                            <td>12-9-2016</td>
                            <td>Đã đăng kí</td>
                            <td><button disabled="true" type="button" class="btn btn-primary"><a href="dangkikpi1.jsp"></a>Đăng Kí</button></td>
                        </tr>
                        <tr class="success">
                            <td>2</td>
                            <td>Biểu Mẫu 2</td>
                            <td>10-12-2016</td>
                            <td>Chưa đăng kí</td>
                            <td><a href="dangkikpi1.jsp"><button type="button" class="btn btn-primary">Đăng Kí</button></a></td>

...
<head>
    <meta charset="UTF-8">
    <title>Web KPI | Quản lý KPI</title>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="#" data-toggle="dropdown"><span class="glyphicon glyphicon-user"></span> Accout<span class="caret"></span></a>
                            <ul class="dropdown-menu">
                                ...
                                <li class="divider"></li>
                                <li><a href="home.jsp"><span class="glyphicon glyphicon-log-out"></span> Đăng xuất</a>
                                </li>
                            </ul>
                        </li>
                      ...
                      <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    <td>Biểu mẫu 1</td>
                                    <td>11-10-16</td>
                                    <td><button type="button" class="btn btn-primary"><a href="#"></a>Xóa</button></td>
                                </tr>
                                <tr>
                                    <td>Biểu mẫu 2</td>
                                    <td>12-10-16</td>

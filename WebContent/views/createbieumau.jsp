...
<form method="POST" action="doCreateBieuMau">
			<div class="row x1">
				<div class="col-md-3">
				...
				<div class="col-md-7">
					<input type="text" class="form-control" id="text"
						placeholder="Nhập tên biểu mẫu" name="tenbieumau" value="${bieumau.tenbieumau}">
				</div>
			</div>
			...
			<div class="row x1">
				...
				<div class="col-md-7">
					<input type="text" class="form-control" id="text"
						placeholder="Nhập năm học" name="namhoc" value="${bieumau.namhoc}">
				</div>
			</div>
			...
			<div class="row x1">
				...
				<div class="col-md-7">
					<input type="text" class="form-control" id="text"
						placeholder="Người tạo" name="username" value="${bieumau.username}">
				</div>
			</div>
			<input type="submit" value="Tạo Biểu Mẫu" class="btn btn-primary" /> <a
					href="BieuMauList">Cancel</a></td>
</form>
		</div>
	</div>
	</div>

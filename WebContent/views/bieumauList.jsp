				...
				<div class="row">
					<div class="col-md-12">
						<div class="table-responsive">
								...
								<tbody>
									<c:forEach items="${bieumauList}" var="bieumau">
										<tr>
											...
											<td><a href="editBieuMau?mabieumau=${bieumau.mabieumau}"><button type="button" class="btn btn-primary">Edit</button></a>
											</td>
											<td><a href="deleteBieuMau?mabieumau=${bieumau.mabieumau}"><button type="button" class="btn btn-warning">Delete</button></a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
							...
							<a href="createBieuMau"><button type="button" class="btn btn-danger">Tạo biểu mẫu</button></a>
						</div>
					</div>
				</div>
			</div>

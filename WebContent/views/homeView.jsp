...
<body>
    <div class="Signup">
        <a class="btn btn-lg btn-success" href="signup.jsp" target="_blank"><span class="glyphicon glyphicon-plus"></span> Sign up   
     </a>
    </div>
    <div class="login">
        <a class="btn btn-lg btn-danger" href="${pageContext.request.contextPath}/login"><span class="glyphicon glyphicon-user"></span> Login   
     </a>
    </div>
